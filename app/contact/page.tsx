...
const infoData = [
  { title: "Phone", description: "+880 18714 97433", icon: <Phone /> },
  { title: "Email", description: "mdmehedi121888@gmail.com", icon: <Mail /> },
  {
    title: "Address",
    description: "Shafipur, Kaliakoir, Gazipur, Dhaka, Bangladesh",
    icon: <MapPinCheck />,
  },
];
